        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_LasttName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DeliveryMethodPrice = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_DeliveryMethods_DelveryMethodId",
                        column: x => x.DelveryMethodId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    product_OrderId = table.Column<int>(type: "int", nullable: true),
                    product_productName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    product_pictuerUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DelveryMethodId",
                table: "Orders",
                column: "DelveryMethodId");
        }
